...
(() => {
        ...
        for (let n = f + 1; n < t.length; n++)
          if (((o = t.charCodeAt(n)), 92 === o)) n += 1;
            ...
            if (59 === o && t.charCodeAt(n + 1) === e)
              throw new Error(
                `Unterminated string: ${
                  t.slice(r, n + 1) + String.fromCharCode(h)
                }`
              );
            if (o === e)
              throw new Error(
    ...
    return (
      z(e, (e) => {
        if ("declaration" === e.kind && e.value && ze.test(e.value))
          return (r |= 8), void (e.value = Te(e.value, t));
        "at-rule" === e.kind &&
          ("@media" === e.name ||
            "@custom-media" === e.name ||
            "@container" === e.name ||
  ...
  function Ue(e) {
    let t = (function (e) {
          ...
          t.functional(n, (t) => {
            ...
            return (
              "arbitrary" === t.value.kind
                ? ((r = t.value.value), (r = ke(r, t.modifier, e)))
                : (r = ye(t, e, o.themeKeys)),
        ...
        let a = () =>
          A([
            be("--tw-border-spacing-x", "0", "<length>"),
            be("--tw-border-spacing-y", "0", "<length>"),
          ]);
          ...
          ]);
        {
          let e = [
            ...
            i = () =>
              A([
                be("--tw-rotate-x", "rotateX(0)"),
                be("--tw-rotate-y", "rotateY(0)"),
                be("--tw-rotate-z", "rotateZ(0)"),
                be("--tw-skew-x", "skewX(0)"),
                be("--tw-skew-y", "skewY(0)"),
              ]);
          for (let t of ["x", "y", "z"])
            o(`rotate-${t}`, {
              supportsNegative: !0,
        ...
        let f = () =>
          A([be("--tw-pan-x"), be("--tw-pan-y"), be("--tw-pinch-zoom")]);
        ...
        n("grid-flow-row", [["grid-auto-flow", "row"]]),
          ...
          o("grid-cols", {
            ...
            handleBareValue: ({ value: e }) =>
              se(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
        ...
        let p = () =>
          A([
            be("--tw-gradient-position"),
            be("--tw-gradient-from", "#0000", "<color>"),
            be("--tw-gradient-via", "#0000", "<color>"),
            be("--tw-gradient-to", "#0000", "<color>"),
            be("--tw-gradient-stops"),
            be("--tw-gradient-via-stops"),
            be("--tw-gradient-from-position", "0%", "<length-percentage>"),
            be("--tw-gradient-via-position", "50%", "<length-percentage>"),
            be("--tw-gradient-to-position", "100%", "<length-percentage>"),
          ]);
        function m(n, o) {
          t.functional(n, (t) => {
            if (t.value) {
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  ...
                  default:
                    return (
                      (r = ke(t.value.value, t.modifier, e)),
          ...
          });
        {
          let e = [
            ...
            a = () =>
              A([
                be("--tw-backdrop-blur"),
                be("--tw-backdrop-brightness"),
                be("--tw-backdrop-contrast"),
                be("--tw-backdrop-grayscale"),
                be("--tw-backdrop-hue-rotate"),
                be("--tw-backdrop-invert"),
                be("--tw-backdrop-opacity"),
                be("--tw-backdrop-saturate"),
                be("--tw-backdrop-sepia"),
              ]);
          ...
          let e =
            ...
            t = () =>
              A([
                be("--tw-ordinal"),
                be("--tw-slashed-zero"),
                be("--tw-numeric-figure"),
                be("--tw-numeric-spacing"),
                be("--tw-numeric-fraction"),
              ]);
          ...
          let o = function (e) {
            ...
            s = () =>
              A([
                be("--tw-shadow", a),
                be("--tw-shadow-color"),
                be("--tw-inset-shadow", a),
                be("--tw-inset-shadow-color"),
                be("--tw-ring-color"),
                be("--tw-ring-shadow", a),
                be("--tw-inset-ring-color"),
                be("--tw-inset-ring-shadow", a),
                be("--tw-ring-inset"),
                be("--tw-ring-offset-width", "0px", "<length>"),
                be("--tw-ring-offset-color", "#fff"),
                be("--tw-ring-offset-shadow", a),
              ]);
              ...
              if (!t.value) {
                ...
                return null === t
                  ...
                  : [
                      ...
                      y(
                        "--tw-inset-shadow",
                        pe(t, (e) => `var(--tw-inset-shadow-color, ${e})`)
                      ),
                      y("box-shadow", l),
                    ];
              }
                ...
                if (r)
                  return t.modifier
                    ...
                    : [
                        ...
                        y(
                          "--tw-inset-shadow",
                          pe(r, (e) => `var(--tw-inset-shadow-color, ${e})`)
                        ),
                        y("box-shadow", l),
                      ];
              }
        ...
        let t = (function (e, t) {
          let r = (function (e, t) {
            if ("arbitrary" === e.kind) {
              let r = e.value;
              return (
                e.modifier && (r = ke(r, e.modifier, t.theme)),
  ...
  async function Ut({
    ...
    if (
      ((e.resolveThemeValue = function (n) {
        return n.startsWith("--")
          ? s(n)
          : ((i |= Wt({
              designSystem: e,
  ...
  async function Mt(e, r = {}) {
    let n = t(e),
      o = await (async function (e, t = {}) {
        ...
        n.unshift(
          x("! tailwindcss v4.0.14 | MIT License | https://tailwindcss.com ")
        );
        let u = new Set(),
          d = null,
          f = 0,
        ...
        return {
          ...
          build(t) {
            ...
            let i = u.size;
            for (let e of t)
              r.invalidCandidates.has(e) ||
                ("-" === e[0] && "-" === e[1]
                  ? r.theme.markUsedVariable(e)
                  : u.add(e),
                (o ||= u.size !== i));
            ...
            return f === s.length
              ? ((d ??= T(n, r)), d)
              : ((f = s.length), (l.nodes = s), (d = T(n, r)), d);
          },
        };
      })(n, r),
      i = n,
